...
public class Storage extends javax.swing.JFrame {
    ...
    public final void showStorage() {
        try {
            String query = "CALL get_storage_2('" + this.pharm_code +  "')";
            stmt = conn.prepareStatement(query);
            rs = stmt.executeQuery(query);
            DefaultTableModel model = (DefaultTableModel) storageTable.getModel();
            Object[] row = new Object[6];
            while(rs.next()) {
                Object o[] = {rs.getString("medi_name"), rs.getString("medi_comp"), rs.getString("quantity"), rs.getString("price")};
                model.addRow(o);
            }
